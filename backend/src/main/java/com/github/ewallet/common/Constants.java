package com.github.ewallet.common;
...
public final class Constants {
    ...
    public static final String ALREADY_EXISTS_CARD = "Card already exists";
    ...
    public static final String NOT_FOUND_CARD = "Requested card is not found";
    ...
    public static final String CREATED_CARD = "Card is created (Credentials: {} --- Expiry Date: {})";
    ...
    public static final String DELETED_CARD = "Card is deleted (Credentials: {} --- Expiry Date: {})";
    ...
    public static final String UPDATED_CARD = "Card is updated (Credentials: {} --- Expiry Date: {})";
}
